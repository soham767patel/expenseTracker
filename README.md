...
## Video Demo
https://youtu.be/1fAf4BDCJaM
* dataCollection.py and newwindow.py are the files that were compiled into final executable
## How it was built
...
3.  **View Data Visualization**: Analyze your financial data through pie or bar charts, with options to view:
